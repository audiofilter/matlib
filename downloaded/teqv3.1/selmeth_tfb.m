...
function [r,subsnr,optimalD,teqfbcoef,feq, title_str,totalRateVector] = selmeth_tfb(method,channel, inputSignal, AWGN, NEXTnoise, Dmin, Dmax, gamma, N, Nw, Nb, delaySearch)
...
if method==1,
        [r,subsnr,optimalD,teqfbcoef,feq,totalRateVector]=teqfb(channel, inputSignal, AWGN, NEXTnoise, Dmin, Dmax, gamma, N, Nw, Nb, delaySearch);
        title_str = sprintf('TEQ Filter bank');
