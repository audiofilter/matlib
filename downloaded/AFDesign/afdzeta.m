function z = afdzeta(n, a, e)

% afdzeta.m  AFD auxiliary function zeta(n,ksi,epsilon)
%   
...
if e >= 0.000000002
 ...
 global ELLIP_ML ELLIP_EPSILON;
 ELLIP_ML = mL;
 ELLIP_EPSILON = e;
 
 v0 = log((sqrt(1+e^2)+1))-log(e);   %v0 = atanh(1/sqrt(1+e^2));
 v = fmins('afdv', v0);
 z = abs(ellipj(v*Ka/(n*KL),ma));
else
 z = 1;
end
