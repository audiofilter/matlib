function Si = afdsnaei(n,a,e,i)

% afdsnaei.m  AFD i-th pole S(n,ksi,epsilon,i) of
%             normalized elliptic lowpass transfer function
%   
...
x = afdxnai(n,a,i);
z = afdzeta(n,a,e);
numre = -z*sqrt(1 - z^2) * sqrt(1 - x^2) * sqrt(1 - x^2/a^2);
numim = x * sqrt(1 - (1-1/a^2)*z^2);
num = numre + I*numim;
den = 1 - (1 - x^2/a^2)*z^2;
Si= num/den;
