...
b5plot = uicontrol('String', 'Plot', 'Units', 'normalized' ...
     ...
     , 'CallBack', ['clf;moreaxis=dfdplot(numD,denD,speca,filnumb,moreaxis,Dtype);dfdesbut']);

b6pass = uicontrol('String', 'Pass', 'Units', 'normalized' ...
     , 'Position', [0.93 0.21 0.07 0.05] ...
     , 'CallBack', 'clf;moreaxis=dfdpass(numD,denD,speca,filnumb,moreaxis,Dtype);dfdesbut');

b7tran = uicontrol('String', 'Tran', 'Units', 'normalized' ...
     , 'Position', [0.93 0.14 0.07 0.05] ...
     , 'CallBack', 'clf;moreaxis=dfdtran(numD,denD,speca,filnumb,moreaxis,Dtype);dfdesbut');

b8stop = uicontrol('String', 'Stop', 'Units', 'normalized' ...
     , 'Position', [0.93 0.07 0.07 0.05] ...
     , 'CallBack', 'clf;moreaxis=dfdstop(numD,denD,speca,filnumb,moreaxis,Dtype);dfdesbut');
