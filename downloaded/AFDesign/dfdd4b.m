function [nD1,dD1,n,a,e,fp] = dfdd4b(speck,ninc,filtype)

% dfdd4b.m  DFD Design alternative D4b
%   
...
if filtype == 'l'
 ...
 n  = n + ninc;
 a  = dfdxmax(n, Fp, Fs, Kp, Ks);
 e  = dfdemin(n, Fp, Fs, Kp, Ks);
 fp = dfdfpmin(n, Fp, Fs, Kp, Ks);
