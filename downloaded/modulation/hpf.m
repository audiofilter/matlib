function  [out] = hpf(fc,in)

% HPF ......... High-pass filter design and filtering.
%
% 	HPF(Fc) specifies a Chebychev high-pass filter of order N with
...
%
% 	[Y] = HPF(Fc,X) returns vector Y obtained through high-pass filtering 
...
filt_order = 8;
[Bc,Ac]    = cheby1(filt_order, ripple, passband,'high');
