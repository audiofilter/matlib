...
## nyquist frequency).  Warning: gain Sg is returned as a complex value
## which may have some residual imaginary component. This matters for
## poles at extreme values in the s-plane, such as those created by odd
## order chebyshev type II low pass filters.
##
...
## TODO: Shoul return real(Sg) rather than complex.  Must fix cheby2 to be
## TODO:    more stable first
