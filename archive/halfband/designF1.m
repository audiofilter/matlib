function [f1,q1,zetap,phi] = designF1(delta, fp1)
% [f1 q1 zetap phi] = designF1(delta, fp1)	Design the F1 sub-filter
...
% Transform h(n) to a chebyshev polynomial a(n)
...
for nsd = 3:8
	...
	% shrinking the neighborhood once 10 successive the trial values show no
...
% Matlab Ver. 5 change:
	    ...
	    [f1a q11] = bquantize( f1a.*phivec, nsd );
	    F1 = evalF1( f1a, testPoints, phia );
